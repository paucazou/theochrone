...
class RechercheMotClef(forms.Form):
    annee = forms.IntegerField(widget=forms.Select(choices = annees),max_value=1960,min_value=2100,required=True,initial=datetime.date.today().year)
