...
def args():
    ...
    affichage.add_argument(*arguments['type']['short'],*arguments['type']['long'],dest='type',action='store_true',help=_("""Prints the type of the liturgical day"""))
    ...
    system.add_argument('--version', action='version',version='%(prog)s 0.6.0')
