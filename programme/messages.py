...
def translated_messages(file_name,language=args.langue):
    ...
    ### i18n ###
    languages = {
    'fr' : gettext.translation('messages',loc,languages=['fr'],fallback=True),
    'en' : gettext.translation('messages',loc,languages=['en'],fallback=True),
    'la' : gettext.translation('messages',loc,languages=['la_LA'],fallback=True),
    }
    ...
    if file_name == "dateparse":
        ...
        feastprinter.propers = {
                ...
                'french'        :feastprinter.markToTranslate('French','french'),
                    'strasburger'   :   feastprinter.markToTranslate('Strasburger','strasburger'),
                'newzealander' :feastprinter.markToTranslate('New-Zealander','newzealander'),
